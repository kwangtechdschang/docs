...
# Hubs
hubs are on-the-ground, physical spaces, which will be identified by a local changemaker or identify themselves as the host of the event. that's the way that the whole onboarding process becomes activated and other stakeholders organise around that. hubs enable the process of co-design. trust cannot be rushed.

**Kwang Tech Hub**, based in Dschang in the West Region of Cameroon, is one such hub. It hosts Web3-focused hackathons and learning programmes in:

- an office space used for day-to-day work and mentoring
- a museum conference room used for larger gatherings and community events

Kwang Tech Hub can currently host hackathons and intensives for up to **50 participants**, focusing on locally relevant, sustainable solutions.

More generally, hubs may take the form of...
